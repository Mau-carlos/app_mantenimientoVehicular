...
{
    public partial class Form_Cliente1 : Form
    {
        EntidadCliente1 cliente = new EntidadCliente1();
        private bool IsNuevo = false;
        private bool IsEditar = false;

        public Form_Cliente1()
        {
            InitializeComponent();
        ...
        private void BuscarApellidos()
        {
            ...
            //this.dataListado.DataSource = NegocioCliente.BuscarApellidos(this.txtBuscar.Text);
            this.OcultarColumnas();
            lblTotal.Text = "Total de Registros: " + Convert.ToString(dataListado.Rows.Count);
        }
        ...
        private void BuscarNum_Documento()
        {
            ...
            //this.dataListado.DataSource = NegocioCliente.BuscarNum_Documento(this.txtBuscar.Text);
            this.OcultarColumnas();
            lblTotal.Text = "Total de Registros: " + Convert.ToString(dataListado.Rows.Count);
        }
        ...
        private void Form_Cliente1_Load(object sender, EventArgs e)
        {
            this.Top = 0;
            this.Left = 0;
            this.Mostrar();
                ...
                if (Opcion == DialogResult.OK)
                {
                    ...
                    foreach (DataGridViewRow row in dataListado.Rows)
                    {
                        if (Convert.ToBoolean(row.Cells[0].Value))
                        {
                            ...
                            Rpta = NegocioCliente.Eliminar(Convert.ToInt32(Codigo));
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    if (this.IsNuevo)
                    {
                        rpta = NegocioCliente.Insertar(this.txtNombre.Text.Trim().ToUpper(),
                    ...
                    {
                        rpta = NegocioCliente.Editar(Convert.ToInt32(this.txtIdcliente.Text),
        ...
        {
            Form_ReporteClientes frm = new Form_ReporteClientes();
            frm.ShowDialog();
        }
